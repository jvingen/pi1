...
class SerialConfig:
    ...
    def bytesize(self, value: int):
        ...
        if value in byte_sizes:
            ...
            raise SerialConfigException(
                f"Baudrate invalid. Valid values: {byte_sizes}"
            )
    ...
    def parity(self, value: str):
        if value.upper() in serial.PARITY_NAMES.keys():
            ...
            raise SerialConfigException(
                f"Parity invalid. Valid values: {list(serial.PARITY_NAMES.keys())}"
            )
    ...
    def stopbits(self, value: int):
        ...
        if value in stopbits:
            ...
            raise SerialConfigException(
                f"Stopbits invalid. Valid values: {stopbits}"
            )
    ...
    def xonxoff(self, value: bool):
        ...
        if value in xonxoff_values:
            ...
            raise SerialConfigException(
                f"Xonxoff invalid. Valid values: {xonxoff_values}"
            )
