...
from smartmeter.collector.exceptions import SerialConfigException


class SerialConfig:
    """A class to provide the datastructures for all serial configuration details"""
    ...
    def __init__(
        ...
        """
        Note: see pyserial for detail explanation of parameters
